...
test('difference between JSON files', () => {
  ...
  expect(diff(firstFile, secondFile, 'json')).toEqual(JSON.stringify(res));
});
...
test('difference between INI files', () => {
  ...
  expect(diff(firstFile, secondFile, 'json')).toEqual(JSON.stringify(resIni));
});
...
test('difference between JSON recursive files', () => {
  ...
  expect(diff(firstFile, secondFile, 'json')).toEqual(JSON.stringify(recRes));
});
